...
public class CommandNotifications extends CommandBase{
	...
	public void processCommand(ICommandSender sender, String[] array) {
		if(sender instanceof EntityPlayer){
			...
			if(array.length > 0){
				...
				sendMessage(player, EnumChatFormatting.RED + "/notifications <amount of tweets>");
			}
		}
	}
	...
	public void view(EntityPlayer player, String[] array){
		try{
			ArrayList<String> tweets = TwitterHelper.getNotifications(Integer.parseInt(array[0]));
